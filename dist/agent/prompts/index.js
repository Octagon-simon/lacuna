...
export function buildGeneratePrompt(args) {
    const { sourceFile, env, existingTestCode, uncoveredFunctions, uncoveredLines, sourceImportPath, mocksCode, mocksImportPath, setupFileCode, packageDeps, tsconfigPaths, typeDefinitions, localImportPaths, localImportContents, reactMajorVersion, projectMemory, existingTestLineCount, } = args;
...
export function buildRetryPrompt(failureOutput, failedAttempts = [], patchMode = false, reactish = true) {
    const parts = [];
